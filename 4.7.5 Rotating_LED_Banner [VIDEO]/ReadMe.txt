...
rotating_LED.v -> Module for rotating LED banner. Edit "W" with the number of desired letters, then edit the "words" register with the desired letters,
...
For example, assume that the message is 10 digits (i.e.,"0123456789"). The display can show the message as "0123", "1234", "2345", . . . ,
