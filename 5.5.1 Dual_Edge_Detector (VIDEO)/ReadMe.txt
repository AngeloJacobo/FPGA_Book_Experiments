...
dual_edge_detector_simpler_TEST.v -> Module that combines: dual_edge_detector_simpler, debouncing_button, and Led_mux.Every press of the "sw" will increment the counter by 2(since its a dual edge detector) which will then be displayed on the seven-segments.
