...
rotate_sq_TEST.v -> Module that combines the rotate_sq module and Led_mux module. "en" is for play/pause and "cw" is for clockwise/counterclockwise control of the rotating boxes
